...
you_want_from = wait.until(EC.visibility_of_element_located((By.XPATH, '//input[@placeholder="Where from?"]')))
you_want_from.send_keys('Bengaluru')
sleep(1)
wait.until(EC.element_to_be_clickable((By.XPATH,'(//li[@class="m-1"])[1]'))).click()

you_want_to = wait.until(EC.visibility_of_element_located((By.XPATH, '//input[@placeholder="Where to?"]')))
you_want_to.send_keys('Jaipur')
sleep(1)
wait.until(EC.element_to_be_clickable((By.XPATH,'(//li[@class="m-1"])[1]'))).click()

when = wait.until(EC.element_to_be_clickable((By.XPATH, '//div[@data-testid="dateSelectOnward"]')))
when.click()
